...
function startGame(){
	...
	enemies.push(new Enemy(-50, floorPos_y, 250))
	enemies.push(new Enemy(-38, floorPos_y, 250))
	enemies.push(new Enemy(-26, floorPos_y, 250))
	enemies.push(new Enemy(-14, floorPos_y, 250))
	enemies.push(new Enemy(-2, floorPos_y, 250))
